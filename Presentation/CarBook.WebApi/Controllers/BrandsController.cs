...
namespace CarBook.WebApi.Controllers
{
    public class BrandsController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> BrandList() => Ok(await _getBrandQueryHandler.Handle());

        [HttpGet("{id}")]
        public async Task<IActionResult> BrandById(int id) => Ok(await _getBrandByIdQueryHandler.Handle(new GetBrandByIdQuery(id)));
